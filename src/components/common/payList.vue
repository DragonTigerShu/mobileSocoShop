  ...
  export default {
    ...
    WeChatListen:function(){
      if(this.orderSn!=null&&this.orderId!=null){
        if(this.isWeiXin()){
          window.location.href = 'http://wx.supersoco.com/scshop/server/index.php?c=Pay&m=payWe&order_sn='+this.orderSn+'&key='+$user.auid;
        }else{
          var newWin = window.open('about:blank');
