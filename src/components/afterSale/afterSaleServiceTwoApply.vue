<template>
  <div class="afterSaleServiceTwoApply">
    <mHead :title="'申请退货退款'" @clickListen="goBack"></mHead>
...
<!--       <section>
    ...
    <content class='money'>
      ...
      <section class="remark-style"><span>最大退款金额:{{data['order_goods']['goods_price']*data['order_goods']['goods_number']}}元</span></section>
      <section style="margin-top:2.14rem"><h1>退货说明</h1><textarea v-model='describe' placeholder="请在此描述问题"></textarea></section>
    </content>
    <content>
      <section class="inline-style">
       <h1>上传凭证</h1>
    ...
    methods:{
      ...
      clickListen:function(){
        if($this.reason==null||$this.reason==''){
          mui.toast('请选择退货理由',{ duration:'short', type:'div' });
          return false;
        }
        ...
        if($this.money>$this.data['order_goods']['goods_price']*$this.data['order_goods']['goods_number']){
