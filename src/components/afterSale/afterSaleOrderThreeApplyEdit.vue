<template>
  <div class="afterSaleServiceThreeApply">
    <mHead :title="'申请换货'" @clickListen="goBack">
...
<script>
  ...
  export default {
        ...
        .then((response) => {
          ...
          switch(parseInt(response.data.code)){
            case 1600100 :{
              ...
              if($selectAddress==0)$selectAddress=$this.data['return_goods_info']['address_id'];
              $this.getListByUser();
    ...
    goAddress:function(){
      $this.$router.push({name:'/afterSaleOrder/afterSaleServiceAddress',params:{returnGoodsId:$this.id}});
    },
